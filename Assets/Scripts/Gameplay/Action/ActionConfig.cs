...
namespace Unity.BossRoom.Gameplay.Actions
{
    ...
    public class ActionConfig
    {
        ...
        [Tooltip("Is this Action Repeatable e.g can set effect multiple times until it's over duration time, time between action set is dependent on ExecTimeSeconds.")]
        public bool Repeat;
        ...
        [Tooltip("Indicates which value should be affeced on skill action use, mana, health or other.")]
        public ActionAffectData ActionAffectData;
