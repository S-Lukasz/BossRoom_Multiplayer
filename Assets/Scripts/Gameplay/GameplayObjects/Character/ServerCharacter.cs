...
namespace Unity.BossRoom.Gameplay.GameplayObjects.Character
{
    ...
    public class ServerCharacter : NetworkBehaviour, ITargetable
    {
        ...
        {
            get => NetManaState != null ? NetManaState.ManaPoints.Value : 0;
            private set { if(NetManaState != null) NetManaState.ManaPoints.Value = value; }
        }
        ...
        void InitializeCharacterPoints()
        {
