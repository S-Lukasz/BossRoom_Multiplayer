...
namespace Unity.BossRoom.Gameplay.UI
{
    ...
    public class PartyHUD : MonoBehaviour
    {
        ...
        [SerializeField]
        private AlertView[] m_AlertViews;
        ...
        void SetHeroData(ClientPlayerAvatar clientPlayerAvatar)
        {
            ...
            m_OwnedServerCharacter.NetManaState.NotEnoughMana += SetHeroAlert;
        ...
        private void SetHeroAlert(string value, bool overwrite)
        {
            m_AlertViews[0].SetData(value, overwrite);
        }
        ...
        void SetAllyData(ClientPlayerAvatar clientPlayerAvatar)
        {
            ...
            serverCharacter.NetManaState.NotEnoughMana += (string value, bool overwrite) =>
            { 
                SetAllyAlert(id, value, overwrite);
            };
        ...
        void SetAllyAlert(ulong id, string value, bool overwrite)
        {
            int slot = FindOrAddAlly(id);
            ...
            m_AlertViews[slot].SetData(value, overwrite);
        }
